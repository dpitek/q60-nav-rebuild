...
chmod 755 /opt/q60planb/spike7 2>/dev/null
...
/opt/q60planb/spike7 > /tmp/q60-planb-stdout.log 2>&1
RC=$?
...
cat > "$UNIT" <<'UNIT_EOF'
[Unit]
Description=Q60 Plan B''' Spike 7 — fixed MapPixmap, no daemon kill
ConditionPathExists=/opt/q60planb/spike7
